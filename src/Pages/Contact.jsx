        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <ScrollAnimation direction="up" delay={0.1}>
            <div className='text-center'>
              <span className="text-[#FF5E15] font-bold text-sm uppercase text-center"> CONTACT US </span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <ScrollAnimation direction="left" delay={0.2}>
              <div className="space-y-6">
                <div className="bg-[#00245C] rounded-3xl p-10 shadow-2xl">

                  {/* Phone Section */}
                  <div className="text-center mb-10">
                    <div className="inline-flex items-center justify-center w-20 h-20 bg-yellow-400/20 rounded-full mb-6">
                      <Phone className="w-10 h-10 text-[#FF5E15]" strokeWidth={1.5} />
                    </div>
                    <p className="text-gray-300 text-sm mb-3">Call Support Center 24/7</p>
                    <a 
                  ...
                  <div className="text-center mb-10">
                    <div className="inline-flex items-center justify-center w-20 h-20 bg-yellow-400/20 rounded-full mb-6">
                      <Mail className="w-10 h-10 text-[#FF5E15]" strokeWidth={1.5} />
                    </div>
                    <p className="text-gray-300 text-sm mb-3">Write To Us</p>
                    <a 
                      href="mailto:Geoleaders.uae@gmail.com" 
                      className="text-white text-xl font-bold hover:text-yellow-400 transition-colors duration-300"
                    >
              ...
              <div className="bg-white rounded-3xl p-8 md:p-10 lg:p-12 shadow-xl">
                ...
                <div className="space-y-6">
                  ...
                  <button
                    ...
                    className="bg-[#FF5E15] hover:bg-yellow-500 text-white font-bold px-12 py-4 rounded-full transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105"
                  >
                    Submit
                  </button>
                </div>
