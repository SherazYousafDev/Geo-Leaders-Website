...
export default function ValuesCardsSection() {
  const values = [
    ...
    },
    {
      ...
      title: "Innovation",
      description:
        "We embrace innovation and continually seek out new technologies and methods to improve our services, ensuring the best outcomes for our clients.",
      icon: Hammer,
    },
    {
      id: 4,
      title: "Quality",
      description:
        "We are dedicated to delivering work of the highest quality, adhering to industry standards and best practices to ensure project success.",
      icon: Layers,
    },
    {
      id: 5,
      ...
      description:
        "Our clients' needs are central to our operations. We work closely with clients to understand their challenges and provide tailored solutions.",
      icon: UserCheck,
    },
    {
      id: 6,
      ...
      description:
        "We are committed to environmentally responsible practices that minimize our impact on the environment and contribute to community sustainability.",
      icon: Leaf,
    },
  ];
          ...
          <ScrollAnimation direction="up" delay={0.1}>
            <div className="mb-16 space-y-4 text-left max-w-4xl">
              ...
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-[var(--color-prim)] leading-tight">
                Our <span className="text-[var(--color-sec)]">Core</span> Values
              </h2>
            ...
            {values.map((value, index) => {
              ...
              return (
                <ScrollAnimation
                  ...
                  delay={0.2 + index * 0.2}
                >
                  <div className="group relative bg-white rounded-xl shadow-lg hover:shadow-2xl transition-all duration-500 overflow-hidden border border-gray-100 hover:border-[var(--color-prim)] h-full flex flex-col justify-between">
                    {/* Card Content */}
                    ...
                    <div className="p-8 pt-0 flex justify-start">
                      <div className="inline-flex items-center justify-center w-24 h-24 bg-[var(--color-prim)] rounded-lg shadow-lg group-hover:scale-110 group-hover:rotate-3 transition-all duration-500">
                        <Icon
